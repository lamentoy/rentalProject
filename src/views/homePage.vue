<template>
  ...
  <div class="middlepart">
   ...
   <div>Rental rise provides a platform for you to compare different neighbourhoods and check other people's favourite neighbourhoods to get an idea of where you want to live.</div>
  ...
  <div class="sigin">
   ...
   <div class="signinbox">
   <el-input v-model="accName" placeholder="Please enter your account name"></el-input>
   </div>
   </div>
   <div class="sigin">
     <div>Password:</div>
   <div class="signinbox">
   <el-input v-model="password" placeholder="Please enter your password"></el-input>
   </div>
   </div>
   <div class="sigin">
